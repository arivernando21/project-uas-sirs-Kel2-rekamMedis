...
<body>
    <div class="layout">
        <div class="sidebar">
            ...
            <a href="manage_user.php" class="active">Manajemen User</a>
            ...
            <div class="content">
                <div class="card form-card">
                    ...
                    <form action="../functions/user_action.php" method="POST">
                        ...
                        <input type="text" name="nama_lengkap" value="<?= $user_to_edit['nama_lengkap'] ?? '' ?>" required>
                        
                        <label>Username</label>
                        <input type="text" name="username" value="<?= $user_to_edit['username'] ?? '' ?>" required>
                        
                        <label>Password <?= $user_to_edit ? "<small>(Kosongkan jika tidak ingin diganti)</small>" : "" ?></label>
                        ...
                        <div style="margin-top: 15px; display: flex; gap: 10px;">
                            <button type="submit" name="<?= $user_to_edit ? 'update_user' : 'add_user' ?>" class="btn-primary">
                                <?= $user_to_edit ? "Update Data" : "Simpan Pengguna" ?>
                            </button>
                            <?php if ($user_to_edit): ?>
                                <a href="manage_user.php" class="btn-outline" style="text-decoration: none; text-align: center; line-height: 35px; height: 35px;">Batal</a>
                            <?php endif; ?>
                        </div>
                    </form>
                </div>
                ...
                <div class="card table-card">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="manage_user.php?edit_id=<?= $u['id_user'] ?>" style="color: blue; text-decoration: none; font-size: 12px; margin-right: 10px;">Edit</a>
                                <a href="../functions/user_action.php?delete_id=<?= $u['id_user'] ?>" onclick="return confirm('Hapus user ini?')" style="color: red; text-decoration: none; font-size: 12px;">Hapus</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </table>
